...
```commandline
git clone git@github.com:Oryshich/django-sprint4.git
```
...
```
## Задание
- __Кастомные страницы для ошибок.__  
...
- __Добавление новых публикаций.__  
...
- __Редактирование публикаций.__  
...
- __Комментарии к публикациям.__  
...
- __Удаление публикаций и комментариев.__  
...
- __Отправка электронной почты.__  
...
## 
109 когорта yandex-practicum [Oryshich](https://github.com/Oryshich).